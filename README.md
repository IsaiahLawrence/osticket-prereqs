...
<p> <img src="https://i.imgur.com/4HTvC7V.png" alt="osTicket logo"/> 
   
We'll click new at the bottom left and enter the password we made when we installed SQL earlier. If done correctly we will be inside HeidiSQL
    <img src="https://i.imgur.com/moeP6YX.png" alt="osTicket logo"/> 
from here we can create our database "osTicket" in HeidiSQL do this by right clicking under test and create new database. Then we return to our osTicket installer fillout the database settings

The SQL database name is "osTicket" and our username is root and enter the same password you used when setting up SQL.</p>
<br />
